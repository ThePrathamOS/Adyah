...
if [ "$TOTAL" = "1234" ]; then
	...
	sudo gdebi -n linux-modules-4.16.16-041616-generic_4.16.16-041616.201806160515_amd64.deb
	sudo gdebi -n linux-headers-4.16.16-041616_4.16.16-041616.201806160515_all.deb
	sudo gdebi -n linux-headers-4.16.16-041616-generic_4.16.16-041616.201806160515_amd64.deb
	sudo gdebi -n linux-image-unsigned-4.16.16-041616-generic_4.16.16-041616.201806160515_amd64.deb
	CurrentUser=$(whoami)
...
sed -i 's/$CurrentKernelFull/4.16.16-041616-generic/g' /opt/essentials/unsyncedupdates.html
notify-send -t 5000 \"PrathamOS Kernel Update\" \"\nUpdating Grub...\"
xfconf-query --channel xfce4-desktop --property /backdrop/screen0/monitor0/workspace0/last-image --set /opt/anapmi/AI.png	
